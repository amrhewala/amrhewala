  ...
  return <section className="bg-gradient-to-br from-primary/5 to-accent/5 py-0">
      <div className="container">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service, index) => <Card key={index} className="group hover:shadow-xl transition-all duration-300">
              <CardHeader>
              ...
              <CardContent>
                ...
                <div className="flex flex-wrap gap-2">
                  {service.tools.map((tool, idx) => <Badge key={idx} variant="secondary" className="hover:bg-accent/20 transition-colors">
                      {tool}
                    </Badge>)}
                </div>
              </CardContent>
