  ...
  return <section className="w-full py-0">
      <div className="container max-w-4xl mx-auto px-4">
        ...
        <div className="space-y-6">
          {education.map((edu, index) => <Card key={index} className="backdrop-blur-sm bg-white/80 border-none shadow-lg hover:shadow-accent/20 transition-all duration-500">
